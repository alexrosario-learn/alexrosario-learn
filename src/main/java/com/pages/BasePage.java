...
import basePackage.Element;
import basePackage.Locators;



public class BasePage extends DriverFactory implements Browser,Element{
	...
	public boolean verifyExactAttribute(WebElement ele, String attribute, String value) {
		try {
			if (ele.getAttribute(attribute).equals(value)) {
				...
				//reportStep("The expected attribute :" + attribute + " value does not contains the actual " + value,"warning");
			}
		} catch (WebDriverException e) {
	...
	public void startApp(String url, boolean headless) {
		System.out.println("Write code to start browser as generic");}

	@Override
	public void startApp(String browser, boolean headless, String url) {
		System.out.println("Start application with headless browser");
	}
